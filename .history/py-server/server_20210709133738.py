    ...
    for y in col_name.find():
        ...
        if x == y["location"]:
            if y["cond"] == "cancer":
                ...
                og_count = loc_count["cancer_count"]

                other_col.find_one_and_update( query={"location": x}, update={"$set": {"cancer_count": og_count}})
                print("updated_canc")
            ...
            if y["cond"] == "typhoid":
                ...
                og_count = og_count+1
                other_col.find_one_and_update( query={"location": x}, update={"$set": {"typhoid_count": og_count}})
                print("updated_typ")
